...
const ROUTES = {
  ...
  'read-me-kpi.html': 'read-me-kpi',
  'read-me-ai.html': 'read-me-ai',
  'read-me-appraisal.html': 'read-me-appraisal',
  'read-me-competency.html': 'read-me-competency',
  'read-me-students-hub-assessment.html': 'read-me-students-hub-assessment',
...
const LINK_REWRITES = [
  ...
  [/href="school-events\.html"/g,          'href="/school-events"'],
  [/href="cambridge-standards\.html"/g,    'href="/cambridge-standards"'],
  [/href="competency-framework\.html"/g,   'href="/competency-framework"'],
  [/href="read-me-kpi\.html"/g,            'href="/read-me-kpi"'],
  [/href="read-me-ai\.html"/g,             'href="/read-me-ai"'],
  [/href="read-me-appraisal\.html"/g,      'href="/read-me-appraisal"'],
  [/href="read-me-competency\.html"/g,     'href="/read-me-competency"'],
  [/href="read-me-students-hub-assessment\.html"/g, 'href="/read-me-students-hub-assessment"'],
...
const { copyFiles, copyDir, resolveSrcDir } = require('./build-tools/copy-tree.js');
{
  ...
  if (pigpSrc) copyFiles(
    ...
    // is the teacher four-pillar one.
...
// References & Standards data — TH now ships its OWN references-data
...
// TH /references reader entries. With the local mirror, TH /references
// is fully self-contained.
//
// SoT for each entry → see scripts/sync/mirror-research-to-hubs.js
// REF_DATA_PLAN['Teachers Hub']. To add a new card, extend that plan
