...
//
// Allowed roles: central_admin, academic_coordinator, teacher
//
...
// All platform roles can access Teachers Hub
const ALLOWED_ROLES = ['central_admin', 'academic_coordinator', 'teacher'];
...
onAuthStateChanged(auth, async (user) => {
  ...
  // 1. Not signed in → redirect to login (index.html handles auth)
  if (!user) {
